...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help") || gArgs.IsArgSet("-version"))
    {
        ...
        std::string strUsage = strprintf(_("%s pulsar-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pulsar-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pulsar transaction") + "\n" +
              "  pulsar-tx [options] -create [commands]   " + _("Create hex-encoded pulsar transaction") + "\n" +
              "\n";
