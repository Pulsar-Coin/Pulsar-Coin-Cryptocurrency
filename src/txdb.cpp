    ...
    while (pcursor->Valid()) {
        ...
        if (pcursor->GetKey(key) && key.first == DB_BLOCK_INDEX) {
            ...
            if (pcursor->GetValue(diskindex)) {
                ...
                if (diskindex.nHeight > nMax)
                    nMax = diskindex.nHeight * 1.25;
                ...
                pindexNew->nTx            = diskindex.nTx;
                 ...
                 // pulsar related block index fields
...
public:
    ...
    // pulsar: whether transaction is a coinstake
    bool fCoinStake;

    // pulsar: transaction timestamp
    unsigned int nTime;
