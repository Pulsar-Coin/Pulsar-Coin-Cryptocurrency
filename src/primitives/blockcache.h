...
class CBlockCache : public unordered_lru_cache<uint256, uint256, std::hash<uint256>>
{
    private:
        static CBlockCache* instance;
    ...
    public:
        ...
        CBlockCache(int maxSize = DEFAULT_BLOCK_CACHE_SIZE, bool validate = false);
        virtual ~CBlockCache();
