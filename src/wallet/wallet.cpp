...
// pulsar: optional setting to unlock wallet for block staking only;
...
//    return n ? n : nTimeReceived;
    ...
    // pulsar: we still have the timestamp, so use it to avoid confusion
    return tx->nTime;
}
...
// pulsar: total coins staked (non-spendable until maturity)
                                ...
                                int& nChangePosInOut, std::string& strFailReason, const CCoinControl& coin_control, bool sign)
{
    ...
    txNew.nTime = wtxNew.tx->nTime;  // pulsar: set time
...
//                }
                ...
                // pulsar: sub-cent change is moved to fee
...
// pulsar: create coin stake transaction
