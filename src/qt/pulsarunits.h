...
#ifndef PULSAR_QT_PULSARUNITS_H
#define PULSAR_QT_PULSARUNITS_H
...
/** Pulsar unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class PulsarUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit PulsarUnits(QObject *parent);
...
typedef PulsarUnits::Unit PulsarUnit;

#endif // PULSAR_QT_PULSARUNITS_H
