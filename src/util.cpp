...
const char * const BITCOIN_CONF_FILENAME = "pulsar.conf";
const char * const BITCOIN_PID_FILENAME = "pulsard.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Pulsar";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Pulsar";
#else
    // Unix
    return pathRet / ".pulsar";
#endif
#endif
}
    ...
    if (!streamConfig.good()){
        ...
        if (configFile != NULL) {
            std::string strHeader = "# Pulsar Coin config file\n"
                          ...
                          "addnode=seed01.pulsarcoin.org\n"
                          "addnode=seed02.pulsarcoin.org\n"
                          "addnode=seed03.pulsarcoin.org\n"
                          "addnode=seed04.pulsarcoin.org\n"
                          "addnode=seed05.pulsarcoin.org\n"
                          "addnode=seed06.pulsarcoin.org\n"
                          "\n"          
                          "# Additional Nodes:\n"
                          "\n";
