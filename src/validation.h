...
static const int MAX_BLOCKS_IN_TRANSIT_PER_PEER = 128;//16;
/** Timeout in seconds during which a peer must stall block download progress before being disconnected. */
static const unsigned int BLOCK_STALLING_TIMEOUT = 180;//2;
...
static const unsigned int BLOCK_DOWNLOAD_WINDOW = 10240;//1024;
...
static const int64_t BLOCK_DOWNLOAD_TIMEOUT_BASE = 100000; //1000000;
/** Additional block download timeout per parallel downloading peer (i.e. 5 min) */
static const int64_t BLOCK_DOWNLOAD_TIMEOUT_PER_PEER = 50000; //500000;
...
static const bool DEFAULT_TXINDEX = true;  // pulsar: txindex is required for PoS calculations (might change in the future)
