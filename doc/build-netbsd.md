...
This guide describes how to build pulsard and command-line utilities on NetBSD.
...
```
git clone https://github.com/PulsarCoin/Pulsar-Coin-Cryptocurrency
```

See [dependencies.md](dependencies.md) for a complete overview.

### Building Pulsar Core
