...
def setup_repos():
    ...
    if not os.path.isdir('pulsar-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/vnetizen/pulsar-detached-sigs.git'])
    if not os.path.isdir('gitian-builder'):
        subprocess.check_call(['git', 'clone', 'https://github.com/devrandom/gitian-builder.git'])
    if not os.path.isdir('pulsar'):
        subprocess.check_call(['git', 'clone', 'https://github.com/vnetizen/pulsar.git'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/vnetizen/pulsar', help='Specify the URL of the repository. Default is %(default)s')
